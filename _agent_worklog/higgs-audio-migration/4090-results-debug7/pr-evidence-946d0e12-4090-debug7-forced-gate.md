...
Supported claim: Native retained-continuation execution only; semantic parity and profiling are unproven.
...
| nsys stats | passed | `/data/results/pegainfer/higgs-audio/profiles/higgs-native-codegen-946d0e12-4090-debug7-forced-gate-stats_cuda_gpu_kern_sum.csv` |
